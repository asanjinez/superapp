...
public interface ICartMapper {
    ...
    @Mapping(target = "personDto", expression = "java(com.superapp.auth_service.person.IPersonMapper.INSTANCE.personToPersonDto(cart.getPerson()))")
    ...
    @Mapping(target = "person", expression = "java(com.superapp.auth_service.IPersonMapper.INSTANCE.personDtoToPerson(cartDto.getPersonDto()))")
